...
description: Convert a chords-over-lyrics, ChordPro, or bracket chord chart into song2html. Use when converting a song chart or when the user runs /convert-chord-chart.
---
